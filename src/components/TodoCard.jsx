...
const TodoCard = ({ todo }) => {
  ...
  return (
    <div className='flex justify-between p-4 bg-white rounded-full mb-4 items-center transition-all duration-300 hover:bg-gray-200'>
      {editMode ? (
        <input
          type='text'
      ...
      <div className='flex gap-4 items-center'>
        {editMode ? (
          <>
            <button
className =
  'px-2 py-2 text-[rgb(73,72,69)] rounded transition-all duration-600 hover:text-black'
